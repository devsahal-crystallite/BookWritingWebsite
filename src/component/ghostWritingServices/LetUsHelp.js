...
const demandingSpecilaist = () => {
    return (
        <>
            <section className="pattern-bg our-voice lg:py-[100px] relative ">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-6">
                        <div className="col-span-1 md:col-span-2 lg:col-span-1">
                            <div className="box text-center bg-[#edeff3] py-6 px-auto items-center justify-center mx-auto rounded-xl">
                                <h4 className='lg:text-xl font-bold text-[#16295c] mx-auto mb-5'>Seal of <br></br> Approval</h4>
                        ...
                        <div className="col-span-1 md:col-span-2 lg:col-span-1">
                            <div className="box text-center bg-[#edeff3] py-6 px-auto items-center justify-center mx-auto rounded-xl">
                                ...
                                <h4 className='lg:text-xl font-bold text-[#16295c] mx-auto mb-5'>Reviewed by <br></br> editors</h4>
                        ...
                        <div className="col-span-1 md:col-span-2 lg:col-span-1">
                            <div className="box text-center bg-[#edeff3] py-6 px-auto items-center justify-center mx-auto rounded-xl">
                                ...
                                <h4 className='lg:text-xl font-bold text-[#16295c] mx-auto mb-5'>Unlimited <br></br> Revisions</h4>
                        ...
                        <div className="col-span-1 md:col-span-2 lg:col-span-1">
                            <div className="box text-center bg-[#edeff3] py-6 px-auto items-center justify-center mx-auto rounded-xl">
                                ...
                                <h4 className='lg:text-xl font-bold text-[#16295c] mx-auto mb-5'>Rights of Ownership Maintained</h4>
